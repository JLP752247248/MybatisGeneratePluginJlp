...
public abstract class AbstractServicePlugin extends PluginAdapter{
    ...
    private GeneratedJavaFile generateServiceInterface(IntrospectedTable introspectedTable) {
        ...
        return new GeneratedJavaFile(serviceInterface, servicePropertyConfig.getServiceTargetProject(), context.getJavaFormatter());
    }
    ...
    private GeneratedJavaFile generateServiceImpl(IntrospectedTable introspectedTable) {
        ...
        FullyQualifiedJavaType serviceJavaType = new FullyQualifiedJavaType(servicePropertyConfig.getServiceClassName());
        FullyQualifiedJavaType serviceImplJavaType = new FullyQualifiedJavaType(servicePropertyConfig.getServiceImplClassName());
        ...
        return new GeneratedJavaFile(clazz, servicePropertyConfig.getServiceImplTargetProject(), context.getJavaFormatter());
